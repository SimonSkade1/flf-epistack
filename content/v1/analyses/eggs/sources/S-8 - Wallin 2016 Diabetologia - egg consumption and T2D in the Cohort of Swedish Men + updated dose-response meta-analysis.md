...
url: https://doi.org/10.1007/s00125-016-3923-6
venue: Diabetologia, 59:1204-1213
...
found_via: named in brief as a discovery hub ("Wallin 2013"); the actual dedicated egg-T2D meta-analysis by this group is this 2016 Diabetologia paper (an earlier Wallin/Larsson 2013 Atherosclerosis-adjacent meta covered CVD+diabetes jointly, see Li et al 2013 Atherosclerosis mined separately by the CVD slice)
motivatedness: none noted
trust_score: 0.75
trust_reason: large 15y cohort with register-based (not self-reported) T2D ascertainment reducing outcome misclassification; COSM result functionally null (p-trend 0.06) and its meta independently reproduces the US (I2=0%) vs non-US split matching S-4.
usefulness: 3.5
usefulness_reason: large European near-null primary plus a second independent statement of the US-vs-non-US heterogeneity - directly discriminating on the region hypothesis.
method_read: 39,610 men, 4,173 cases, 15y register follow-up; HRs 0.98/1.11/1.11, p-trend 0.06; meta US(5) HR 1.18 (1.13-1.24) I2=0% vs non-US(7) 0.97 (0.90-1.05).
standing: Diabetologia; Swedish Research Council + MRC funded, no COI; heterogeneity independently reproduced by S-4.
angle: egg-T2D-cohort
data_basis: [[D-9]]
