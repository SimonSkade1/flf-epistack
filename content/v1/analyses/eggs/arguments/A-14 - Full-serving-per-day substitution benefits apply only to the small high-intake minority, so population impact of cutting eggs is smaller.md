...
id: A-14
type: argument
statement: "Because a one-serving/day substitution presupposes at least one serving/day of current intake, the large per-day risk reductions apply only to the ~8% eating that many eggs, so the population-average benefit of reducing eggs is much smaller than the per-day HRs suggest."
source: "[[S-89 - Substitution analysis- replacing eggs with other protein foods and CVD-mortality risk]]"
locator: "Results (% consuming); Discussion"
affects_observations: ["[[O-42 - Only 8 percent of participants ate at least one egg serving per day in the pooled US cohorts]]", "[[O-39 - Replacing one serving per day of eggs with nuts, legumes, whole grains or fish lowers incident CVD by 15-21 percent]]"]
---
