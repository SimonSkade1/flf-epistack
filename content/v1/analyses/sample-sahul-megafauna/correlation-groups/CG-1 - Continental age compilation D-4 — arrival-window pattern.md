...
Both member observations rest on the same age compilation [[D-4 - Continental late-Quaternary age compilation, group R]], so they are one witness, not two, and are priced by a single joint likelihood here.
