---
name: flf-epistack
description: The FLF EpiStack analysis pipeline — turning one contested empirical question into a Bayesian, navigable Obsidian knowledge base in 10 steps. Invoked explicitly: step 0 runs the whole pipeline, steps 1-10 run one step each (by number or description); not auto-triggered.
---
